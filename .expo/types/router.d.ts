...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/..\components\log\Log` | `/..\components\log\LogExerciseSet` | `/..\components\log\LogExerciseSetItem` | `/..\components\log\Timer` | `/..\services\builders\LogBuilder` | `/_sitemap` | `/exercises` | `/exercises/builder/new` | `/log` | `/log\start\[id]` | `/workouts` | `/workouts/builder/exercises` | `/workouts/builder/new`;
