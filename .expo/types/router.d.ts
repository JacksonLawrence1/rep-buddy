...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/..\components\exercises\ExerciseBuilderComponent` | `/..\components\inputs\NumberPicker` | `/..\components\workouts\WorkoutBuilderComponent` | `/..\components\workouts\WorkoutBuilderForm` | `/_sitemap` | `/exercises` | `/exercises/builder/new` | `/log` | `/store` | `/workouts` | `/workouts/builder/exercises` | `/workouts/builder/new`;
